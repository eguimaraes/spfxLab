...
import styles from './DatatablesItrequestsWebPart.module.scss';
import * as strings from 'IItRequestsStrings';

export interface IDatatablesItrequestsWebPartProps {
  description: string;
}

var $: any = (window as any).$;
export default class DatatablesItrequestsWebPart extends BaseClientSideWebPart<IDatatablesItrequestsWebPartProps> {
